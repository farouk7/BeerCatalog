...
import io.haufe.beercatalogueservice.config.JwtTokenProvider;
...
public class UserControllerImp {
    ...
    private static Logger log = LoggerFactory.getLogger(UserControllerImp.class);
    ...
    public ResponseEntity<String> authenticate(@RequestBody Users user) {
        log.info("UserControllerImp : authenticate");
